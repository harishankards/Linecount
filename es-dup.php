...
function reload()
{
        setTimeout(function(){ window.location = "es-dup.php";}, 0);
}
  ...
  <div id="wrapper">
    ...
    <table border="0" cellpadding="0" align="center" style="font-size:11px; width:815px;"> 
        ...
        <td width="65%">
            ...
            <center><p style="color:#FF0000; font-size:12pt;"><b>*&nbsp; Please Update your linecount <a href="es-dupview.php">Here</a></b></p></center>
            ...
            <table align="center" cellspacing="3" width="400" cellpadding="2">
               ...
               <tr align="left">
                ...
                <tr align="left">
                    <td>Line Count</td>
                    <td>:</td>
                    <td><input type="text" name="lines" id="lines" size="7" maxlength="7" class="text ui-widget-content ui-corner-all" autocomplete="off" ><span style="color:#FF0000; font-size:9pt;"></td>
                </tr>
  ...
  $(function() {
    $( "#dialog-message" ).dialog({
      ...
      buttons: {
        Ok: function() {
          $( this ).dialog( "close" );
		  document.location.href = "es-dup.php";
        }
      }
    });
  });
...
<?php
if(isset($_POST['p_id'],$_POST['shift'],$_POST['day'],$_POST['f_hos'],$_POST['dsp_status'],$_POST['fileno'],$_POST['type']))
{
	...
	$f_mls_id=$_SESSION['ES-EDITOR'];//MLS Name
