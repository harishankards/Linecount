          ...
          <?php
			...
			if($count>0)
			{
				...
				{	
					...
					Print "<td align=\"center\" ><table><tr><td style=\"border:0px;\"><a><img src=\"menu/notes.png\" title=\"Edit Employee details\" height=\"20\" width=\"20\" onclick=\"update('".$row['ID']."');\" ></a></td><td style=\"border:0px;\"><a><img src=\"menu/button-cross_sticker.png\" height=\"20\" width=\"20\" title=\"Delete Employee details\" onclick=\"deleteemp('".$row['ID']."');\"></a></td></tr></table></td> "; 
					Print "<td>".$row['ID'] . "</td> ";
				...
				Print "<script type=\"text/javascript\" language=\"javascript\">
						function update(emp_no)
						{
							...
							{
								window.location = \"viewmlsprofile.php?up_no=\"+eno;
							}
							else
							{
								return false;
						...
						function deleteemp(emp_no)
						{
							...
							{
								window.location = \"viewmlsprofile.php?del_emp_no=\"+eno;
							}
							else
							{
								return false;
