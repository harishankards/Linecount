...
if(isset($_POST['start'],$_POST['end']))
{
	...
	print("S.No \t Name \t Second Level Editing \t Third Level Editing \t Auditing \t DUP Lines \t Non DUP \t Total \t Double pay \t  \t  \t \r");
	$c=1;
		...
		if($cl_count!=0)
		{
			...
			{	
				...
				if(($ed_count!=0) || ($th_count!=0) || ($au_count!=0) || ($dup_count!=0))	
				{
					...
					print("$c \t $name ($cl_name) \t $edtr_lines \t $th_edtr_lines \t $audit_lines \t $edtr_dup_lines \t  $edtr_ndup_lines \t $total_editor_lines \t $double\r");
					$c=$c+1;
				}			
			}
		}
