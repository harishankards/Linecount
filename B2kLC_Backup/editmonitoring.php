    ...
    <div id="main"><br>
     ...
     <td>:</td>
		...
		{	
			...
			{
				echo "<option selected=\"selected\" value=\"-1\">--Select Name--</option>";
			}
		}
		else
		{
...
{	
	...
	$result=mysql_query("SELECT `Date`,`Hospital`,`File_No`,`Linecount`,`Uploadedby`,`Editedby` FROM `file_details`  WHERE `Date` ='$dat' AND `Editedby`!='Not yet Edited'");
	$missing_result=mysql_query("SELECT `Date`,`Hospital`,`File_no`,`Linecount`,`Edit_by` FROM `missing_files` WHERE `Date`='$dat'");
	$audit_result=mysql_query("SELECT `Date`,`Hospital`,`File_no`,`Linecount`,`Audit_by` FROM `audit_files` WHERE `Date`='$dat'");
	$ser="Search results ";
}
echo "<div id=\"tabs\" >
          <ul>
...
if($result)
{
	...
	{	
		...
		echo "<table border=\"1\" cellpadding=\"2\" cellspacing=\"0\" width=\"800\" align=\"center\" class=\"ui-widget ui-widget-content ui-corner-all\" style=\"font-size: 11px;\">";
		echo "<tr class=\"ui-widget-header\"><th>S.No.</th><th>Date</th><th>Hospital</th><th>File No</th><th>LineCount</th><th>Uploaded By</th><th>Edited By</th></tr>";
...
{	
	...
	{	
		...
		echo "<div id=\"detail\" style=\"width:850px; height: 400px; border: 0px groove #3b3a3a; overflow: auto;\">";
		echo "<table border=\"1\" cellpadding=\"2\" cellspacing=\"0\" width=\"800\" align=\"center\" class=\"ui-widget ui-widget-content ui-corner-all\" style=\"font-size: 11px;\">";
		echo "<tr class=\"ui-widget-header\"><th>S.No.</th><th>Date</th><th>Hospital</th><th>File No</th><th>LineCount</th><th>Edited By</th></tr>";
