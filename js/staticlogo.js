function repeat()
{
	var ori=Math.floor((Math.random()*4)+1);
	return ori;
}

var ddsitelogo={
	setting: {orientation:4, visibleduration:0, fadeduration:[3000, 2000]}, //orientation=1|2|3|4, duration=millisec or 0, fadedurations=millisecs
	offsets: {x:10, y:10},//offset of logo relative to window corner
	logoHTML: '<a href="http://www.b2ktrans.com" target="_blank"><img src="images/logo.png" alt="B2k Medical Transcription" height="28" width="60" /></a>', //HTML for logo, which is auto wrapped in DIV w/ ID="mysitelogo"
	...
	init:function(){
		jQuery(document).ready(function($){
			...
			mainobj.$control=$('<div id="b2klogo">'+mainobj.logoHTML+'</div>')
